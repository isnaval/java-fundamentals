...
public class ExperimentoFisico extends ExperimentoConOrganismo {

	public ExperimentoFisico(String nombre, String descripcion, String organismo, int nivelAmenaza,
	...
	public void analizarResultados() {
		System.out.println("Análisis específico para experimento físico '" + getNombre() + "':");
